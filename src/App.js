import "./App.css";
import { Testimonio } from "./assets/testimonios";
function App() {
  return (
    <div className="App">
      <div className="contenedor-principal">
        ...
        <Testimonio
          ...
          nombre="Shawn Wang"
          pais="Singapore"
          cargo="Software Engineer at"
          empresa="Amazon"
          texto="It's scary to change careers. I only gained confidence that I could code by working through the hundreds of hours of free lessons on freeCodeCamp. Within a year I had a six-figure job as a Software Engineer."
        />
        <Testimonio
          foto="sara"
          nombre="Sarah Chima"
